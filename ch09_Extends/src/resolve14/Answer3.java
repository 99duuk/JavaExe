...
import resolve14.question03.BaseBallMenu;
import resolve14.question03.DecisionBall;
import resolve14.question03.GeneratorThreeNum;
...
public class Answer3 implements IQuestionAnswer {
	...
	public void answer(Scanner sc) {
		...
		System.out.println("정확하게 맞추셨습니다. 추카포카~");
