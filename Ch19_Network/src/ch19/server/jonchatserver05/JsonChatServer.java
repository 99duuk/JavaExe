package ch19.server.jonchatserver05;
 ...
 * 		- 병렬처리 위해 Client 1개당 Thread 1개를 배정
 * 		
 * 	3) JsonChatServer
 * 		- 多 업무 처리 위해 Json 포맷 사용(패킷) 
 * 		- 채팅은 1사람한테 수신한 데이터를 다른 사람에게 전달해야 한다. 
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (true) {
				...
				/* worker thread는 Client와 통신을 담당한다. */
...
//			String line;
			while (true) {
				/* client 가 json 오브젝트를 string으로 변환해서 보낸 것을 수신 */
